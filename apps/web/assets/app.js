...
const actionLabel=action=>({"membership.created":"创建团队成员","membership.role_changed":"调整成员角色","brand.created":"创建品牌","product.created":"创建农产品","knowledge.created":"录入知识","knowledge.submitted":"知识已提交审核","knowledge.approved":"知识审核通过","knowledge.rejected":"知识被驳回","content_project.created":"创建内容任务","content.generated":"AI 生成内容","content_version.created":"创建内容版本","content_version.submitted":"内容已提交审核","content_version.approved":"内容审核通过","content_version.rejected":"内容被驳回"}[action]||action);
