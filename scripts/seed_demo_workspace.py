...
def seed_demo_content(
    ...
    *,
    ...
    live_project, live_version = ensure_project(
        client,
        creator_token=creator_token,
        reviewer_token=reviewer_token,
        brand=brand,
        ...
        content_type="livestream_product_pitch",
        approve=False,
    )
    return {
        ...
        "content_projects": [
            ...
            },
            {
                ...
                "content_type": live_project["content_type"],
                "latest_version_id": live_version["id"],
                "latest_version_status": live_version["status"],
            },
        ],
    }
