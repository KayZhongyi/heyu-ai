...
1. 先在 Issue 或团队沟通渠道确认任务范围与负责人。
2. 优先选择能在一个 PR 内完成、验证和回退的小任务。
3. 开始前写清楚验收条件；涉及接口时，同时确认权限、租户与错误状态。
4. 若发现任务与他人的分支重叠，先协商拆分文件或职责，不要互相覆盖。

推荐按能力方向认领：

| 方向 | 适合的任务 |
| --- | --- |
| 产品 / 内容 | 用户流程、验收用例、简中 / 香港繁中 / 英文文案 |
| Web | 页面交互、响应式、可访问性、Playwright E2E |
| API / AI | FastAPI、数据模型、RBAC、知识检索、生成 Provider |
